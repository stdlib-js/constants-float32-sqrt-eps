...
```javascript
import FLOAT32_SQRT_EPS from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-sqrt-eps@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/constants-float32-sqrt-eps/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/constants-float32-sqrt-eps/actions/workflows/test.yml?query=branch:v0.2.3
